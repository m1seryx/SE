...
import CustomizationPage from './src/pages/CustomizationPage';
import ReviewPage from './src/pages/ReviewPage';
import './Customization2DWrapper.css';

// Import the data from the 2dtryy app
...
const Customization2DWrapper = ({ onClose, onConfirmOrder }) => {
  ...
  const handleFinalOrder = () => {
    // Pass the customization data back to the main app
    if (onConfirmOrder) {
      onConfirmOrder({
        ...customization,
        fabricSampleFile,
  ...
  return (
    <div className="customization-2d-wrapper">
      <div className="customization-2d-header">
        <h2>2D Customization Tool</h2>
        <button className="close-btn" onClick={onClose}>×</button>
      </div>
      
      <div className="customization-2d-content">
        {page === "customize" && (
          <CustomizationPage
...
export default Customization2DWrapper;